...
return [
    ...
    'intro' => 'This website uses cookies in order to enhance the overall user experience. <br/><br/>By clicking “Accept All”, you agree to the storing of cookies on your device to enhance site navigation, analyse site usage, and assist in our marketing efforts.',
    'link' => 'Take a look at our <a href=":url">Cookies Policy</a> for more information.',

    'essentials' => 'Only essentials',
    'all' => 'Accept all',
    'customize' => 'Customize preference',
    'manage' => 'Manage cookies',
    'reset' => 'Reset cookies preference',
    'details' => [
        'more' => 'More details',
        'less' => 'Less details',
    ],
