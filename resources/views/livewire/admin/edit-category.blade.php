        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-6">
                <div class="flex justify-between items-start flex-wrap">
                    <p class="uppercase text-sm">Edit Category Information</p>
                ...
                <div class="flex flex-wrap items-start -mx-3">
                    ...
                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                        <div class="mb-4">
                            ...
                            <input type="number" wire:model="pricePerUnit" id="pricePerUnit" step="0.01" min="0" 
                                class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />                            
                    ...
                    <div class="w-full h-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                        <div class="mb-4">
                            <label for=""
                                class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">Check to indicate if category can have units</label>
                            <label for="isCountable" class="flex cursor-pointer items-start gap-4 rounded-lg border border-gray-300 p-4 transition hover:bg-gray-50">
                    ...
                    {{-- <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                        <div class="w-full my-6">
                            ...
                            @else
                                <p class="font-bold text-sm">Category image</p>
                                <img src="{{ url('storage/' . $item->photo_url) }}" alt="item photo" class="block w-56 h-56 rounded-xs shadow">
                            @endif
                        </div>
                        <div class="relative w-full mt-4">
                            <div class="items-center justify-center max-w-xl mx-auto">
                                <p class="text-sm font-bold text-gray-900">Change picture</p>
                                <label for="photo"
